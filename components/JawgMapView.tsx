...
const mockLocations: MapLocation[] = [
  ...
  {
    id: '2',
    name: 'Mananchira Square Reading',
    type: 'quest',
    latitude: 11.2497,
    longitude: 75.7681,
    participants: 12,
